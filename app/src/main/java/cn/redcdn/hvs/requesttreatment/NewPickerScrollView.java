...
public class NewPickerScrollView extends View {
    ...
    private int mColorText = this.getResources().getColor(R.color.btn_color_gray);
    ...
    public NewPickerScrollView(Context context) {
        super(context);
        init();
    }

    public NewPickerScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void drawData(Canvas canvas) {
        ...
        if(String.valueOf(scale).equals("1.0")){
            mPaint.setColor(this.getResources().getColor(R.color.white));
        }else{
            mPaint.setColor(this.getResources().getColor(R.color.btn_color_gray));
        }
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        float d = (float) 2*(MARGIN_ALPHA * mMinTextSize * position + type
            * mMoveLen);
        float scale = parabola(mViewHeight / 4.0f, d);
        float size = (mMaxTextSize - mMinTextSize) * scale + mMinTextSize;
        CustomLog.d(TAG,"drawOtherText,scale:"+ String.valueOf(scale)
