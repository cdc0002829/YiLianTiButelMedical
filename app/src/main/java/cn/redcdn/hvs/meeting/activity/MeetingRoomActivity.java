...
public class MeetingRoomActivity extends BaseActivity implements View.OnClickListener,View.OnTouchListener, OnRefreshListener {
    ...
    protected void initView() {
        ...
        swiper = (RefreshLayout) findViewById(R.id.swipe_meeiting);
        swiper.setOnRefreshListener(this);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(MeetingRoomActivity.this));
    ...
    private void getMeetingInfo(final String meetingIdStr, final boolean addPut) {
        final GetMeetingInfomation gi = new GetMeetingInfomation() {
            ...
            protected void onSuccess(MeetingInfomation responseContent) {
                ...
                //TODO 不知道作用
                // isAddCliclk = false;
                String nube = AccountManager.getInstance(MeetingRoomActivity.this)
                ...
                if (responseContent.meetingStatus == 3) {//会议已经结束
                    ...
                    CustomToast
                            .show(MeetingRoomActivity.this, MeetingEndText, Toast.LENGTH_SHORT);
                    return;
                }
                ...
                MDSAccountInfo info = AccountManager.getInstance(
                        MeetingRoomActivity.this).getAccountInfo();
                if (info != null) {
                    if (responseContent.meetingType == 2) {//预约会议
                        ...
                        Intent i = new Intent(MeetingRoomActivity.this,
                        ...
                        if (responseContent.hasMeetingPwd == 0) {//无会议密码  0
                            ...
                            if (String.valueOf(meetingHost).equalsIgnoreCase(info.getNube())) {//我召开的
                                ...
                                iv.setClass(MeetingRoomActivity.this, InputMeetingPasswordDialog.class);
                                //TODO 不知道作用
            ...
            protected void onFail(int statusCode, String statusInfo) {
                ...
                if (statusCode == -906) {
                    ...
                    CustomToast
                            .show(MeetingRoomActivity.this, InvalidAccountText, Toast.LENGTH_SHORT);
                    return;
                }
                // if (statusCode == -999) {
                ...
                if (HttpErrorCode.checkNetworkError(statusCode)) {
                    CustomToast.show(MeetingRoomActivity.this, getString(R.string.login_checkNetworkError),
                            Toast.LENGTH_LONG);
                    return;
                }
                if (statusCode == SettingData.getInstance().tokenUnExist
                        || statusCode == SettingData.getInstance().tokenInvalid) {
                    AccountManager.getInstance(MeetingRoomActivity.this).tokenAuthFail(
                            statusCode);
                }
                ...
                CustomToast.show(MeetingRoomActivity.this, JoinMeetingFailText + statusCode,
                        Toast.LENGTH_SHORT);
            }
        };
        ...
        if (result == 0) {
            ...
            CustomToast.show(MeetingRoomActivity.this, getString(R.string.get_meeting_info_fail), CustomToast.LENGTH_SHORT);
        }
    ...
    private void joinMeeing(String meetingId) {
        ...
        if (i == 0) {
            ...
            CustomToast.show(MeetingRoomActivity.this, getString(R.string.join_consultation_fail),
        ...
        switch (mr) {
            case meetinglist://有会议记录
                ...
                mRecyclerView.setAdapter(
                        mAdapter = new MeetingListAdapter(meetingInfos, MeetingRoomActivity.this));
                            ...
                            public void onItemClick(View view, MeetingItem meetingItem) {
                                ...
                                if (meetingItem.meetingType == 2) {
                                    ...
                                    if (MedicalMeetingManage.getInstance().getActiveMeetingId().equals(meetingItem.meetingId)||TextUtils.isEmpty(MedicalMeetingManage.getInstance().getActiveMeetingId())){
                                        ...
                                        CustomToast.show(MeetingRoomActivity.this,getString(R.string.is_video_meeting) + MedicalMeetingManage.getInstance().getActiveMeetingId(),CustomToast.LENGTH_SHORT);
                                    }
                                }
                            }
                        });
    ...
    private void showMoreTitle() {
                    ...
                    new PopDialogActivity.MenuInfo(R.drawable.meeting_consult_meeting_activity_multi,
                            ...
                            new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    iHoldMeeting.setClass(MeetingRoomActivity.this,
        ...
        startActivity(new Intent(MeetingRoomActivity.this, PopDialogActivity.class));
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.conference_meeting_layout://召开会诊
                ...
                if (!TextUtils.isEmpty(MedicalMeetingManage.getInstance().getActiveMeetingId())){
                    ...
                    if (i == 0) {
                        ...
                        CustomToast.show(MeetingRoomActivity.this, getString(R.string.convene_consultation_fail), CustomToast.LENGTH_SHORT);
            ...
            case R.id.meeting_consult_meetining_join_meeting:
                ...
                if (number.length() != 8) {
                    CustomToast.show(MeetingRoomActivity.this, getString(R.string.consult_meetingid_cannot_more_than_8_size), CustomToast.LENGTH_SHORT);
                } else {
                    // hideInputView();
    ...
    private void initHostoryList() {
        ...
        if (meetingid.equals("")) {
            ...
            adapter = new HistoryListAdapter(middleList, MeetingRoomActivity.this);
