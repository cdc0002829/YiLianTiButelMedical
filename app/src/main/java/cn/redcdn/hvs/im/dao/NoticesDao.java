...
public class NoticesDao {
     ...
     */
    public Cursor queryAllNotices(String convstId) throws Exception {
        CustomLog.i(TAG, "queryAllNotices()");
     ...
     */
    public Cursor queryCondNotices(String convstId, long recvTimeBegin) throws Exception {
        CustomLog.i(TAG,
            "queryCondNotices() | convstID = " + convstId + "recvTimeBegin = " + recvTimeBegin);
    ...
    public Cursor queryPageNotices(String convstId, long recvTimeBegin, int pageCnt)
        throws Exception {
        CustomLog.i(TAG, "queryPageNotices()");
    ...
    public String createSendFileNotice(String sender, String receiver,
        ...
        CustomLog.i(TAG, "createSendFileNotice()");
    ...
    public String createAddFriendTxt(String msgid, String receiver, String sender,
        ...
        CustomLog.i(TAG, "createAddFriendTxt()");
