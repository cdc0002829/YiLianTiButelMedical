...
public class ViewPhotosActivity extends BaseActivity implements View.OnClickListener {
    ...
    public class SamplePagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            final MyMediaController myMediaController
                = (MyMediaController) downloadingView.findViewById(R.id.plyer_mmc);
            final ImageView videoIconView = (ImageView) downloadingView.findViewById(
                R.id.video_icon);
            final FrameLayout viewContainer = (FrameLayout) downloadingView.findViewById(
                R.id.container);
            ...
            downloadingView.findViewById(R.id.delate)
            ...
            downloadingView.findViewById(R.id.play_btn)
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                ...
                public void onViewTap(View view, float x, float y) {
                    ...
                    if (isRemoteFile && mListPhoto != null
                        ...
                        if (photo != null
                            ...
                            if (downLoadingFailed.get(photo.getTaskId()) != null &&
                                downLoadingFailed.get(photo.getTaskId()) == true) {
                            ...
                            if (!TextUtils.isEmpty(localPathf)
                                ...
                                if (locVidFile.exists()) {
                                    if (photo.getLocalPath().toLowerCase().endsWith(".wmv")
                                        ...
                                        downloadingView.findViewById(R.id.error_video_type_layout)
                                            .setVisibility(View.VISIBLE);
                                        downloadingView.findViewById(R.id.error_video_type_layout)
                                            .setVisibility(View.VISIBLE);
                                        TextView videoName
                                            = (TextView) downloadingView.findViewById(
                                            R.id.video_name_tv);
                                        String sourceFileName = photo.getLocalPath()
                                            .substring(photo.getLocalPath()
                                                .lastIndexOf("/") + 1);
                                        ...
                                        downloadingView.findViewById(R.id.play_btn)
                                            .setOnClickListener(new View.OnClickListener() {
                                                @Override
                                                public void onClick(View view) {
                                                    IMCommonUtil.playVideo(mContext,
                                                        photo.getLocalPath());
                                                }
                                            });
                                    } else {
                                        ...
                                        myMediaController.setVideoPath(photo.getLocalPath(),
                                            isSilentPlay);
                                        ...
                                        videoView.setOnErrorListener(
                                            new MediaPlayer.OnErrorListener() {
                                                ...
                                                public boolean onError(MediaPlayer mediaPlayer, int i, int i1) {
                                                    downloadingView.findViewById(
                                                        R.id.error_video_type_layout)
                                                        .setVisibility(View.VISIBLE);
                                                    TextView videoName
                                                        = (TextView) downloadingView.findViewById(
                                                        R.id.video_name_tv);
                                        ...
                                        myMediaController.setCloseCallbackListener(
                                            new CloseCalback() {
                                                @Override
                                                public void close() {
                                                    finish();
                    ...
                    if (NetConnectHelper.getNetWorkType(mContext) ==
                        NetConnectHelper.NETWORKTYPE_INVALID) {
                        CustomToast.show(mContext, getString(R.string.net_error_wait_try_again),
                            Toast.LENGTH_SHORT);
                        finish();
                    } else {
            ...
            photoViewThumbnail.setOnLongClickListener(new android.view.View.OnLongClickListener() {
                @Override
                        ...
                        if (!TextUtils.isEmpty(localPathf)
                            ...
                            if (locVidFile.exists()) {
                                if (photo.getLocalPath().toLowerCase().endsWith(".wmv")
                                    ...
                                    downloadingView.findViewById(R.id.error_video_type_layout)
                                        .setVisibility(View.VISIBLE);
                                    TextView videoName = (TextView) downloadingView.findViewById(
                                        R.id.video_name_tv);
                                    String sourceFileName = photo.getLocalPath()
                                        .substring(photo.getLocalPath()
                                            .lastIndexOf("/") + 1);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (NetConnectHelper.NETWORKTYPE_WIFI ==
                        NetConnectHelper.getNetWorkType(mContext)) {
                        // 当前是wifi连接，直接下载
                        attachProgressView(obj.downLoadingView, obj.id, obj.remoteUrl,
                            obj.photoView, obj.position);
                    } else {
                        if (NetConnectHelper.NETWORKTYPE_INVALID ==
                            NetConnectHelper.getNetWorkType(mContext)) {
                            // 当前无网络连接，放弃下载
    ...
    private class ProgressListener extends ChangeUIInterface {
        ...
        public void onStart(FileTaskBean bean) {
            ...
            if (downloadView != null) {
                runOnUiThread(new Runnable() {
                    public void run() {
                        LinearLayout progressLine = (LinearLayout) downloadView.findViewById(
                            R.id.loading_line);
        ...
        public void onProcessing(FileTaskBean bean, long current, long total) {
            ...
            if (downloadView != null) {
                final LinearLayout progressLine = (LinearLayout) downloadView.findViewById(
                    R.id.loading_line);
                final ImageView videoIconIV = (ImageView) downloadView.findViewById(
                    R.id.video_icon);
            ...
            if (photoView != null && mContext != null) {
                if (photoBean.getType() == FileTaskManager.NOTICE_TYPE_VEDIO_SEND) {
                    if (photoBean.getLocalPath().toLowerCase().endsWith(".wmv")
                        ...
                        downloadView.findViewById(R.id.error_video_type_layout)
                            .setVisibility(View.VISIBLE);
                        TextView videoName = (TextView) downloadView.findViewById(
                            R.id.video_name_tv);
                        String sourceFileName = photoBean.getLocalPath()
                            .substring(photoBean.getLocalPath()
                                .lastIndexOf("/") + 1);
                        videoName.setText(sourceFileName);
                    } else {

                        final VideoView videoView = (VideoView) downloadView.findViewById(
                            R.id.video_view);
                        final MyMediaController myMediaController = (MyMediaController) downloadView
                            .findViewById(R.id.plyer_mmc);
                        final ImageView videoIconView = (ImageView) downloadView.findViewById(
                            R.id.video_icon);

                        final FrameLayout viewContainer = (FrameLayout) downloadView.findViewById(
                            R.id.container);
                        ...
                        myMediaController.setCloseCallbackListener(
                            new ViewPhotosActivity.CloseCalback() {
                                @Override
                                public void close() {
                                    finish();
                                    if (videoView != null) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(filePath)) {
                    if (new File(filePath).exists()) {
                        ...
                        CustomToast.show(this, getString(R.string.have_save_local_album),
                            Toast.LENGTH_SHORT);
                        return;
                    }
                } else {
                    //                    alertMassage(getString(R.string.copy_fail));
                    CustomToast.show(this, getString(R.string.save_fail_wait_try_again),
                        Toast.LENGTH_SHORT);
                    return;
                }
                new Thread(new Runnable() {
            ...
            switch (msg.what) {
                case 1:
                    if ((Boolean) msg.obj) {
                        ...
                        // 发广播刷新系统媒体库
                        CustomToast.show(ViewPhotosActivity.this,
                            getString(R.string.have_save_local_album), Toast.LENGTH_SHORT);
