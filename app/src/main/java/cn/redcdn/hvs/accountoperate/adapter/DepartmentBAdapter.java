...
public class DepartmentBAdapter extends BaseAdapter {
    private List<MDSDepartmentInfoB> arrayList;
    private Context context;

    public DepartmentBAdapter(List<MDSDepartmentInfoB> arrayList, Context context) {
        this.arrayList = arrayList;
        this.context = context;
    }

    public void setArrayList(List<MDSDepartmentInfoB> arrayList) {
        this.arrayList = arrayList;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        MDSDepartmentInfoB department = arrayList.get(i);
        holder.textView.setText(department.getDepartmentName());
        return view;
    }
