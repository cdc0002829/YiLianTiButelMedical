...
public class DoctorApproveActivity extends BaseActivity {
    ...
    private void submitUserInfo() {
        ...
        final MDSAppSubmitUserInf submitUserInf = new MDSAppSubmitUserInf() {
            ...
            protected void onFail(int statusCode, String statusInfo) {
                ...
                if (statusCode == MDS_TOKEN_DISABLE) {
                    ...
                    CustomToast.show(DoctorApproveActivity.this,getString(R.string.your_account_verify), Toast.LENGTH_LONG);
        ...
        DoctorApproveActivity.this.showLoadingView(getString(R.string.submit_verify), new DialogInterface.OnCancelListener() {
                            @Override
        ...
        {
            CustomToast.show(DoctorApproveActivity.this, getString(R.string.upload_doctor_certification), CustomToast.LENGTH_LONG);
            removeLoadingView();
            return;
        }
        submitUserInf.newappSubmitUserInfo(accessToken, headUrl, previewUrl, name, phone, email, accoutType, nube, hospital, workUnitType, department, position, officeTel, certUrl, certPreUrl,remarks);
//        // 获取packagemanager的实例
...
//        submitUserInf.newAppSubmitUserInfo(accessToken, headUrl, previewUrl, name, phone, email, accoutType, nube, hospital, workUnitType, department, position, officeTel, certUrl, certPreUrl,versionNo);
    ...
    private void showDialog() {
        ...
        cid.setCameraClickListener(new CameraImageDialog.CameraClickListener() {
            ...
            public void clickListener() {
                ...
                if (!result) {
                    CustomToast.show(DoctorApproveActivity.this, getString(R.string.open_camera_per), CustomToast.LENGTH_SHORT);
                }
                camera();
            }
        });
    ...
    private void upLoad(String path) {
        UploadManager.UploadImageListener listener = new UploadManager.UploadImageListener() {
            ...
            public void onFailed(int statusCode, String msg) {
                ...
                if (HttpErrorCode.checkNetworkError(statusCode)) {
                    CustomToast.show(DoctorApproveActivity.this, getString(R.string.login_checkNetworkError),
                            Toast.LENGTH_LONG);
                    return;
                }
        ...
        DoctorApproveActivity.this.showLoadingView(getString(R.string.up_pic), new DialogInterface.OnCancelListener() {
